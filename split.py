...
with open("data/results_500/transforms.json") as f:
    data = json.load(f)
...
with open("data/results_500/transforms_train.json", "w") as f:
    json.dump(train, f, indent=4)

with open("data/results_500/transforms_val.json", "w") as f:
    json.dump(val, f, indent=4)

with open("data/results_500/transforms_test.json", "w") as f:
